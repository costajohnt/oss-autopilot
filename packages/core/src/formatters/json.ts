...
import type { DetectedFormatter, CIFormatterDiagnosis } from '../core/formatter-detection.js';
...
/** Output of the detect-formatters command (#703) */
export interface DetectFormattersOutput {
